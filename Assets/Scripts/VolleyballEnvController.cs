...
public class VolleyballEnvController : MonoBehaviour
{
    ...
    Renderer blueHoopRenderer;

    Renderer purpleHoopRenderer;
    ...
    void Start()
    {
        ...
        blueHoopRenderer = blueHoop.GetComponent<Renderer>();
        purpleHoopRenderer = purpleHoop.GetComponent<Renderer>();
        RenderersList.Add(blueHoopRenderer);
        RenderersList.Add(purpleHoopRenderer);
    ...
    public void ResolveEvent(Event triggerEvent)
    {
        switch (triggerEvent)
        {
            ...
            case Event.HitBlueHoop:
                // blue wins
                // blueAgent.AddReward(1f);
                // purpleAgent.AddReward(-1f);

                // turn floor blue
                StartCoroutine(HoopScoredSwapGroundMaterial(volleyballSettings.blueHoopMaterial, RenderersList, .5f));
            ...
            case Event.HitPurpleHoop:
                // purple wins
                // purpleAgent.AddReward(1f);
                // blueAgent.AddReward(-1f);

                // turn floor purple
                StartCoroutine(HoopScoredSwapGroundMaterial(volleyballSettings.purpleHoopMaterial, RenderersList, .5f));
    ...
    IEnumerator HoopScoredSwapGroundMaterial(Material mat, List<Renderer> rendererList, float time)
    {
